...
from hw.embeddings.word2vec.dataloader.iterators import InMemoryIterator, FileIterator
...
class WikiText2Dataset(WikiTextDataset):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(dataset_name="wikitext-2", split="train", *args, **kwargs)
...
class WikiText103Dataset(WikiTextDataset):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(dataset_name="wikitext-103", split="train", *args, **kwargs)
